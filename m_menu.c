...
setup_menu_t cred_settings[]={
  ...
  //Gibbon - changed Team Eternity to Woof Team (Thanks Fabian and all!)
  {"SDL2 code By",S_SKIP|S_CREDIT,m_null, CR_X, CR_Y + CR_S*woof + CR_SH*cr_woof},
  {"Woof Team",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X2, CR_Y + CR_S*woof + CR_SH*cr_woof},

  //Gibbon - thanks to me! :)
  {"64bit port",S_SKIP|S_CREDIT,m_null, CR_X, CR_Y + CR_S*gibbon + CR_SH*cr_gibbon},
  {"Gibbon (Adam)",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X, CR_Y + CR_S*gibbon + CR_SH*cr_gibbon},
  ...
  {"TeamTNT/Eternity",S_SKIP|S_CREDIT|S_LEFTJUST,m_null, CR_X2, CR_Y + CR_S*(adcr+1)+CR_SH*cr_adcr},

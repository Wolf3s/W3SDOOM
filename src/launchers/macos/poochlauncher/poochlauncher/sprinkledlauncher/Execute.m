...
static void WriteResponseFile(const char *args)
{
    FILE *fstream;
...
static void DoExec(const char *executable, const char *args)
{
    char *argv[3];
...
void ExecuteProgram(const char *executable, const char *args)
{
    pid_t childpid;
